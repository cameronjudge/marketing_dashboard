...
def general_metrics_page():
    ...
    with col1:
        ...
        if not active_shops_growth.empty:
            ...
            st.plotly_chart(fig_shops_growth, use_container_width=True)
    ...
    with col2:
        ...
        if not awesome_growth.empty:
            ...
            st.plotly_chart(fig_awesome_growth, use_container_width=True)
    ...
    if combined_growth_data:
        ...
        st.plotly_chart(fig_combined_rate, use_container_width=True)
